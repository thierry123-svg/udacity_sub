...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    with open(dogfile, "r") as infile:
        ...
        while line != "":
            ...
            for i in range(0, len(line), 1):
                if lines[i] not in dognames_dic:
                    dog_names[lines[i]] = 1
         
            print("------- in checking the dog_name line in dict {}".format(dognames_dic))
    ...
    for key in results_dic:
        print("The result dictionary in adjust_4_dog method is {}".format(results_dic))
