...
#                                                                             
# PROGRAMMER:   THIERRY NGAH A ZOCK
# DATE CREATED:  06/05/2020                        
# REVISED DATE:  06/05/202
...
def classify_images(images_dir, results_dic, model):
    ...
    for key in results_dic:
       ...
       print("The results dictionary in the classify hints function is {}".format(results_dic))
       ...
       while (model_label != ""):
        {
         model_label.lower().lstrip(model_label)
       ...
       if truth in model_label:
           results_dic[key] = [model_label]
           results_dic[key] = results_dic[key].extend(1)
       ...
       # the extend function 
           ...
           results_dic[key] = [model_label]
           results_dic[key] = results_dic[key].extend(0)
